"""
URL configuration for PZAFIRA project.
...
schema_view = get_schema_view(
   openapi.Info(
      title="PZAFIRA-Clothing",
      default_version='v1',
      description="API documentation for PZAFIRA cloth store",
      terms_of_service="https://www.google.com/policies/terms/",
      contact=openapi.Contact(email="pzafira.info@gmail.com"),
